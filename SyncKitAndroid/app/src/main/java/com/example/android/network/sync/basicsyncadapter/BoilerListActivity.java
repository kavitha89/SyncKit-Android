...
public class BoilerListActivity extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_boiler_list);
        final ListView listview = (ListView) findViewById(R.id.boilerListView);

        List<Boiler> transformerList = buildData();
        String[] from = { Boiler.KEY_NAME,Boiler.KEY_LOCATION };
        int[] to = { android.R.id.text1,android.R.id.text2 };


        ListAdapter adapter = new BoilerListAdapter(this, transformerList, android.R.layout.simple_list_item_2, new String[] {
                Boiler.KEY_NAME, Boiler.KEY_LOCATION }, new int[] { android.R.id.text1, android.R.id.text2 });
